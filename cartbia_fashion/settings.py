"""
Django settings for cartbia_fashion project.
...
ROOT_URLCONF = 'cartbia_fashion.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'store.context_processors.imenu_links',
...
WSGI_APPLICATION = 'cartbia_fashion.wsgi.application'
...
AUTH_TOKEN = '70be0113ca1083ead6119490ce0492ac'
